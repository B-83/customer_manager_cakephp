...
<!-- テーブル -->
    ...
    <form id="entry" method="post" th:object="${customer}" action="/customer/redirect/check">
    ...
    <div class="table">
      <table class="table table-bordered table-sm table-hover table-list">
          ...
          <tr>
          	<th>名称</th>
            <td><input name="name" th:value="*{name}" id="name" class="width-650" maxlength="40" form="entry" type="text" />
            <span th:if="${#fields.hasErrors('name')}" th:errors="*{name}" style="color: red; margin-left: 10px;">必須項目です。</span>
            </td>
          </tr>
          <tr>
         		<th>かな</th>
            <td><input name="kana" th:value="*{kana}" id="kana" class="width-650" form="entry" type="text" />
          ...
          <tr>
            ...
            <td><input name="postalCode" th:value="*{postalCode}" maxlength="7" id="postal_code" class="width-100" form="entry" type="text" />
          ...
          <tr>
          	<th>住所1</th>
            <td><select name="address1" id="address1" class="table-form-select" form="entry">
          ...
          <tr>
            <th>住所2</th>
            <td><input name="address2" th:value="*{address2}" maxlength="100" id="address2" class="input-width-max" form="entry" type="text" /></td>
          </tr>
          <tr>
